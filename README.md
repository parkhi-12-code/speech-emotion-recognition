...
![Dataset](https://img.shields.io/badge/Dataset-RAVDESS-purple)
![Accuracy](https://img.shields.io/badge/Accuracy-60%25-yellowgreen)
...
This project builds a Speech Emotion Recognition (SER) system from scratch — not a tutorial reproduction. The goal was to build a principled ML pipeline, understand where it breaks, and fix it.

**The journey involved two model collapses, a discovered data leakage bug, and a 9.6M parameter explosion** — all documented below.
